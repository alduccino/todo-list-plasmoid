...
PlasmoidItem {
    ...
    readonly property string _cfgItemBgColor:  Plasmoid.configuration.itemBgColor
    readonly property real   itemBgOpacity:    Plasmoid.configuration.itemBgOpacity
    readonly property real   itemBlurRadius:   Plasmoid.configuration.itemBlurRadius
    readonly property string _cfgTypeBgColor:  Plasmoid.configuration.typeBgColor
    readonly property real   typeBgOpacity:    Plasmoid.configuration.typeBgOpacity
    readonly property real   typeBlurRadius:   Plasmoid.configuration.typeBlurRadius
    readonly property string _cfgInputBgColor: Plasmoid.configuration.inputBgColor
    readonly property real   inputBgOpacity:   Plasmoid.configuration.inputBgOpacity
    readonly property string _cfgEditBgColor:  Plasmoid.configuration.editBgColor
    readonly property real   editBgOpacity:    Plasmoid.configuration.editBgOpacity

    // ── Effective colours ──────────────────────────────────────────────
    readonly property color itemBgColor:  useSystemTheme ? Kirigami.Theme.backgroundColor         : _cfgItemBgColor
    readonly property color typeBgColor:  useSystemTheme ? Kirigami.Theme.highlightColor           : _cfgTypeBgColor
    readonly property color inputBgColor: useSystemTheme ? Kirigami.Theme.alternateBackgroundColor : _cfgInputBgColor
    readonly property color editBgColor:  useSystemTheme ? Kirigami.Theme.positiveTextColor        : _cfgEditBgColor
    // ──────────────────────────────────────────────────────────────────
            ...
            background: Kirigami.Icon {
                ...
                states: [
                    State {
                        ...
                        PropertyChanges { target: backIcon; opacity: 0.4 }
                    }
                ]
            }
        }
